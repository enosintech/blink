...
const About = () => {
  ...
  return (
    <div className='pt-24 w-full text-white px-10 sm:px-14 md:px-20 lg:px-24 xl:px-32 relative z-10 bg-trigger pb-5 md:pb-20 xl:pb-32'>
      ...
      <div className='mt-20 md:mt-32 w-full h-[220px] sm:h-[300px] md:h-[400px] xl:h-[500px] 2xl:h-[600px] md:rounded-lg lg:rounded-xl rounded-md overflow-hidden relative imgTrigger'>
