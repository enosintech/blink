      ...
      <div className="relative w-full h-full px-10 sm:px-14 md:px-20 lg:px-24 xl:px-32 flex flex-col pt-10 md:pt-0 justify-center">
        ...
        <div className='flex flex-col gap-8 md:gap-10 lg:gap-12 -translate-y-20 md:translate-y-0'>
            <div className='flex flex-col gap-3 md:gap-6'>
                ...
                <p className='font-normal text-sm sm:text-base md:text-lg lg:text-2xl 2xl:text-3xl lg:max-w-[85%] max-w-[95%] description-text opacity-0'>We are an innovative marketing firm that comprises an exceptional team of marketing and industry experts built to help our clients achieve profitable growth through creating, implementing, and sustaining marketing strategies.</p>
            </div>
